...
var mapbox_sphericalmercator = new (require('@mapbox/sphericalmercator'))();
...
http.createServer(function(req, res) {
  ...
  if (req.url.indexOf("map") == -1) {
    ...
    the_strings = req.url.split('/'); // (http://)thescentmap.herokuapp.com/map/z/x/y.png
    console.log("the_strings = ");
    console.log(the_strings);
    the_y = the_strings[4].replace(".png", "");
    the_x = the_strings[3];
    the_z = the_strings[2];
    console.log(the_x);
    console.log(the_y);
    ...
    //  "size": 256
    //});
    var bbox = mapbox_sphericalmercator.bbox(parseInt(the_x),
                                           parseInt(the_y),
